...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      void main() {
        ...
        #include <colorspace_fragment>
      }`,transparent:!0,depthTest:!0,depthWrite:!1,side:2,clipping:!0,toneMapped:!1}),h=new Si(p,m);return h.frustumCulled=!1,h.renderOrder=10,{mesh:h,material:m,texture:f}}function vd(e){let t=(0,D.useRef)(null),n=(0,D.useRef)(e),r=(0,D.useRef)(()=>{}),i=(0,D.useRef)(()=>{}),[a,o]=(0,D.useState)(``);(0,D.useEffect)(()=>{n.current=e},[e]),(0,D.useEffect)(()=>{let e=t.current;if(!e)return;let a;try{a=new tu({antialias:!0,alpha:!1})}catch{let e=window.setTimeout(()=>o(`无法启动三维显示，请启用浏览器硬件加速后重试。`),0);return()=>window.clearTimeout(e)}let s=new Ki;s.background=new W(15199728);let c=new Li(34,1,5,12e4);a.setPixelRatio(Math.min(window.devicePixelRatio,2)),a.outputColorSpace=_t,a.toneMapping=4,a.toneMappingExposure=1.18,a.localClippingEnabled=!0,Object.assign(a.domElement.style,{width:`100%`,height:`100%`,display:`block`}),e.appendChild(a.domElement);let l=new Ds(a),u=new Tu,d=l.fromScene(u,.045);s.environment=d.texture,u.dispose(),s.add(new Co(16777215,6321285,2.2));let f=new Fo(16777215,3.2);f.position.set(-1100,1900,2400),s.add(f);let p=new Fo(15003647,2.2);p.position.set(1900,100,-1700),s.add(p);let m=td();s.add(m.root);let h=[],g=new Set,_=(e,t)=>{m.root.getObjectByName(e)?.traverse(e=>{let n=e;if(!n.material)return;let r=n.material,i=e=>{if(!(e instanceof no))return e;g.add(e);let n=e.clone();return h.push({material:n,baseColor:n.color.clone(),baseEmissive:n.emissive.clone(),baseEmissiveIntensity:n.emissiveIntensity,temperatureC:t}),n};n.material=Array.isArray(r)?r.map(i):i(r)})};rd.forEach((e,t)=>_(`环形电堆 ${t+1}`,e.meanC)),cd.forEach(e=>_(e.targetName,e.shellC));let v=nd(),y=[{key:`bypass`,mode:`bypass`,style:`propulsion`},{key:`supply`,mode:`supply`,style:`dense`},{key:`supplyInduction`,mode:`supply`,style:`induction`},{key:`reaction`,mode:`reaction`,style:`normal`}].map(e=>({name:e.key,mode:e.mode,..._d(v[e.key],e.key,gd[e.key],e.style)}));y.forEach(e=>s.add(e.mesh));let b=new Qo(6e3,60,11977931,13753312);b.position.set(950,-650,0),s.add(b);let x=new fu(c,a.domElement);x.enableDamping=!0,x.minDistance=650,x.maxDistance=9e4,x.target.set(950,0,0);let S=m.axialLayout(n.current.explodeAmount);function C(){let e=Xt.degToRad(c.fov),t=2*Math.atan(Math.tan(e/2)*c.aspect),r=n.current.viewMode===`exploded`,i=r?new H(-.08,.15,1):n.current.viewMode===`complete`?new H(.62,.27,1):new H(-.2,.18,1);i.normalize(),x.target.set(950,0,0);let a=new H().crossVectors(c.up,i).normalize(),o=new H().crossVectors(i,a),s=0,l=r?[S.minX-100,S.maxX+100]:[-500,2450];for(let n of l)for(let r of[-620,620])for(let c of[-620,620]){let l=new H(n,r,c).sub(x.target),u=l.dot(i);s=Math.max(s,u+Math.abs(l.dot(a))/Math.tan(t/2),u+Math.abs(l.dot(o))/Math.tan(e/2))}c.position.copy(x.target).add(i.multiplyScalar(s*1.09)),x.update()}r.current=C,i.current=()=>{x.target.set(1830,0,0),c.position.set(3200,540,1500),x.update()};let w=!0,T=0,E=0,D=0,O=()=>{let t=e.clientWidth,n=e.clientHeight;t===T&&n===E||(T=t,E=n,a.setSize(t,n,!1),c.aspect=t/Math.max(n,1),c.updateProjectionMatrix(),y.forEach(e=>e.material.uniforms.uResolution.value.set(t,n)),w&&=(C(),!1))},k=new ResizeObserver(()=>{cancelAnimationFrame(D),D=requestAnimationFrame(O)});k.observe(e),O();let A=new oa(new H(0,0,-1),0),j=new Set;m.root.traverse(e=>{let t=e;t.material&&(Array.isArray(t.material)?t.material:[t.material]).forEach(e=>{e.userData.noCutawayClip||j.add(e)})});let ee=new Ro,M=0,te=0,ne=``,N=n.current.explodeAmount,P=!1,re=!1;a.debug.onShaderError=()=>{re||(re=!0,o(`气流显示加载失败，请刷新页面重试。`))};function ie(){M=requestAnimationFrame(ie);let e=Math.min(ee.getDelta(),.05),t=n.current;if(A.constant=t.cutPosition,N!==t.explodeAmount&&(S=m.axialLayout(t.explodeAmount),N=t.explodeAmount,t.viewMode===`exploded`&&C()),ne!==t.viewMode){C(),ne=t.viewMode;let e=t.viewMode===`complete`?[]:[A];j.forEach(t=>{t.clippingPlanes=e,t.needsUpdate=!0}),y.forEach(t=>{t.material.clippingPlanes=e,t.material.needsUpdate=!0})}if(P!==t.temperatureMode){for(let e of h){let n=new W(pd(e.temperatureC));e.material.color.copy(t.temperatureMode?e.baseColor.clone().lerp(n,.82):e.baseColor),e.material.emissive.copy(t.temperatureMode?n:e.baseEmissive),e.material.emissiveIntensity=t.temperatureMode?.14:e.baseEmissiveIntensity}P=t.temperatureMode}for(let n of m.parts){let r=t.viewMode===`exploded`?S.offsets.get(n.group):0;n.group.position.x=Xt.damp(n.group.position.x,r,8,e),n.group.position.y=0,n.group.position.z=0}for(let e of m.cutawayDetails)e.visible=t.viewMode!==`complete`;for(let e of m.cutawayHidden)e.visible=t.viewMode!==`cutaway`;if(t.fanRunning)for(let t of m.rotors)t.group.rotation[t.axis]+=t.rate*e;if(t.fanRunning)for(let t of m.inductionSpriteMaterials)t.rotation-=4.6*e;te+=e*t.flowSpeed;for(let e of y)e.mesh.visible=t.viewMode!==`exploded`&&(t.flowMode===`all`||t.flowMode===e.mode),e.material.uniforms.uTime.value=te,e.material.uniforms.uTemperatureMode.value=+!!t.temperatureMode;b.visible=t.viewMode!==`exploded`&&c.position.y>-870,x.update(),a.render(s,c)}return ie(),()=>{cancelAnimationFrame(M),cancelAnimationFrame(D),k.disconnect(),x.dispose();let e=new Set;s.traverse(t=>{let n=t;n.geometry&&e.add(n.geometry),n.material&&(Array.isArray(n.material)?n.material:[n.material]).forEach(e=>j.add(e))}),e.forEach(e=>e.dispose());let t=new Set;j.forEach(e=>{let n=e;n.map&&t.add(n.map),e.dispose()}),g.forEach(e=>e.dispose()),t.forEach(e=>e.dispose()),y.forEach(e=>e.texture.dispose()),d.dispose(),l.dispose(),a.dispose(),a.domElement.remove()}},[]);let s=e.temperatureMode&&e.viewMode!==`exploded`?`条件温度场 · 六级电堆 / 电机壳体 / 沿程气流`:e.viewMode===`exploded`?`同轴顺序分解 · 气流已隐藏`:e.flowMode===`all`?`三路气流 · 入口渐扩 / 环道外缘增压 / 三级全环引射 / 尾部双壁收缩`:e.flowMode===`off`?`气流已隐藏`:hd[e.flowMode];return(0,Q.jsxs)(`div`,{ref:t,className:`model-host`,children:[a&&(0,Q.jsx)(`div`,{className:`error`,role:`alert`,children:a}),(0,Q.jsxs)(`div`,{className:`view-head`,children:[(0,Q.jsx)(`div`,{children:(0,Q.jsx)(`p`,{className:`mode`,children:s})}),(0,Q.jsxs)(`div`,{className:`view-buttons`,children:[e.viewMode!==`exploded`&&(0,Q.jsx)(`button`,{onClick:()=>i.current(),children:`尾喷口视角`}),(0,Q.jsx)(`button`,{className:`icon`,onClick:()=>r.current(),"aria-label":`复位视角`,children:(0,Q.jsx)(ne,{size:17})}),(0,Q.jsx)(`button`,{className:`icon`,onClick:()=>t.current?.requestFullscreen?.(),"aria-label":`全屏显示`,children:(0,Q.jsx)(M,{size:17})})]})]}),(0,Q.jsxs)(`div`,{className:`legend`,children:[e.viewMode===`exploded`?(0,Q.jsx)(`span`,{children:`前端 → 主电机与环道外缘增压级 → 六级电堆、两级区间风扇与三级环形引射器 → 双壁收缩尾部与尾锥`}):(0,Q.jsx)(Q.Fragment,{children:e.temperatureMode?(0,Q.jsxs)(`span`,{className:`temperature-key`,children:[(0,Q.jsx)(`b`,{children:`气流 / 部件温度`}),(0,Q.jsx)(`i`,{className:`temperature-gradient`}),`−24°　0°　25°　55°　110°C`]}):(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsxs)(`span`,{children:[(0,Q.jsx)(`i`,{style:{background:`#087fea`}}),`外涵推进气流`]}),(0,Q.jsxs)(`span`,{children:[(0,Q.jsx)(`i`,{style:{background:`#0caf78`}}),`新鲜空气直通`]}),(0,Q.jsxs)(`span`,{children:[(0,Q.jsx)(`i`,{style:{background:`#17cfe3`}}),`引流入堆气流`]}),(0,Q.jsxs)(`span`,{children:[(0,Q.jsx)(`i`,{style:{background:`#e78218`}}),`渐扩中间主流`]})]})}),e.viewMode===`cutaway`&&!e.temperatureMode&&(0,Q.jsxs)(`span`,{children:[(0,Q.jsx)(`i`,{style:{background:`#d6a43f`}}),`主电机短轴传动；环道风扇仅外缘转子旋转`]}),(0,Q.jsx)(`span`,{className:`help`,children:`拖动旋转 · 滚轮缩放 · 右键平移`})]})]})}var $=[{id:`complete`,label:`完整模型`},{id:`cutaway`,label:`整体半剖`},{id:`exploded`,label:`分解视图`}],yd=[{id:`all`,label:`全部气流`,color:`#315e6e`},{id:`bypass`,label:`外涵推进`,color:`#087ff5`},{id:`supply`,label:`新鲜空气`,color:`#0caf78`},{id:`reaction`,label:`中间主流`,color:`#e78218`},{id:`off`,label:`隐藏气流`,color:`#8ca1aa`}];function bd(){let[e,t]=(0,D.useState)(`cutaway`),[n,r]=(0,D.useState)(`all`),[i,a]=(0,D.useState)(1.25),[o,s]=(0,D.useState)(!0),[c,l]=(0,D.useState)(0),[u,d]=(0,D.useState)(.65),[f,p]=(0,D.useState)(!0);return(0,Q.jsxs)(`main`,{className:`page-shell`,children:[(0,Q.jsxs)(`header`,{className:`topbar`,children:[(0,Q.jsxs)(`div`,{children:[(0,Q.jsxs)(`div`,{className:`eyebrow`,children:[(0,Q.jsx)(`span`,{}),` FLOW VISUALIZATION / 215-CELL GEOMETRY REVISION`]}),(0,Q.jsx)(`h1`,{children:`环形燃料电池推进器`})]}),(0,Q.jsx)(`div`,{className:`status-badges`,children:(0,Q.jsx)(`span`,{children:`主风扇 Ø1000 · 六堆 Ø350—Ø590`})})]}),(0,Q.jsxs)(`div`,{className:`workspace`,children:[(0,Q.jsxs)(`section`,{className:`viewer-column`,children:[(0,Q.jsx)(`div`,{className:`toolbar`,children:(0,Q.jsx)(`div`,{className:`segmented`,role:`group`,"aria-label":`观察模式`,children:$.map(n=>(0,Q.jsx)(`button`,{className:e===n.id?`active`:``,onClick:()=>t(n.id),children:n.label},n.id))})}),(0,Q.jsx)(`div`,{className:`viewport-wrap`,children:(0,Q.jsx)(vd,{viewMode:e,flowMode:n,flowSpeed:i,fanRunning:o,cutPosition:c,explodeAmount:u,temperatureMode:f})}),(0,Q.jsxs)(`section`,{className:`panel sizing-panel`,children:[(0,Q.jsx)(`h2`,{children:`六级尺寸 · mm`}),(0,Q.jsxs)(`table`,{className:`sizing-table`,children:[(0,Q.jsx)(`thead`,{children:(0,Q.jsxs)(`tr`,{children:[(0,Q.jsx)(`th`,{children:`级`}),(0,Q.jsx)(`th`,{children:`外径`}),(0,Q.jsx)(`th`,{children:`径高`}),(0,Q.jsx)(`th`,{children:`轴长`}),(0,Q.jsx)(`th`,{children:`片数`})]})}),(0,Q.jsx)(`tbody`,{children:Au.map((e,t)=>(0,Q.jsxs)(`tr`,{children:[(0,Q.jsx)(`td`,{children:t+1}),(0,Q.jsxs)(`td`,{children:[`Ø`,e.outerDiameter]}),(0,Q.jsx)(`td`,{children:e.activeRadial}),(0,Q.jsx)(`td`,{children:e.mechanicalAxial}),(0,Q.jsx)(`td`,{children:e.cells})]},t))})]})]})]}),(0,Q.jsxs)(`aside`,{className:`side-panel`,children:[(0,Q.jsxs)(`section`,{className:`panel`,children:[(0,Q.jsx)(`h2`,{children:`显示模式`}),(0,Q.jsxs)(`div`,{className:`display-modes`,role:`group`,"aria-label":`显示模式`,children:[(0,Q.jsx)(`button`,{className:f?``:`active`,onClick:()=>p(!1),"aria-pressed":!f,children:`流路模式`}),(0,Q.jsx)(`button`,{className:f?`active`:``,onClick:()=>{p(!0),t(`cutaway`),r(`all`)},"aria-pressed":f,children:`温度模式`})]})]}),f&&(0,Q.jsxs)(`section`,{className:`panel thermal-panel`,children:[(0,Q.jsx)(`h2`,{children:`巡航条件温度 · 6000 m / 30 m/s`}),(0,Q.jsx)(`p`,{className:`panel-copy`,children:`按选定的 75 kW 条件解显示。彩色粒子表示沿程估算气温；电堆颜色表示等效平均堆温，不代表局部热点。`}),(0,Q.jsxs)(`table`,{className:`sizing-table thermal-table`,children:[(0,Q.jsx)(`thead`,{children:(0,Q.jsxs)(`tr`,{children:[(0,Q.jsx)(`th`,{children:`堆`}),(0,Q.jsx)(`th`,{children:`电功率`}),(0,Q.jsx)(`th`,{children:`风量`}),(0,Q.jsx)(`th`,{children:`气温 进→出`}),(0,Q.jsx)(`th`,{children:`堆温`})]})}),(0,Q.jsx)(`tbody`,{children:rd.map((e,t)=>(0,Q.jsxs)(`tr`,{children:[(0,Q.jsx)(`td`,{children:t+1}),(0,Q.jsxs)(`td`,{children:[e.powerKw.toFixed(1),` kW`]}),(0,Q.jsx)(`td`,{children:e.flowKgS.toFixed(2)}),(0,Q.jsxs)(`td`,{children:[e.inletC.toFixed(1),`→`,e.outletC.toFixed(1),`°`]}),(0,Q.jsxs)(`td`,{children:[(0,Q.jsx)(`span`,{className:`thermal-dot`,style:{background:pd(e.meanC)}}),e.meanC.toFixed(1),`°`]})]},t))})]}),(0,Q.jsx)(`p`,{className:`thermal-subhead`,children:`电机壳体条件估算`}),(0,Q.jsx)(`div`,{className:`motor-temperatures`,children:cd.map(e=>(0,Q.jsxs)(`div`,{children:[(0,Q.jsxs)(`span`,{children:[(0,Q.jsx)(`i`,{className:`thermal-dot`,style:{background:pd(e.shellC)}}),e.label]}),(0,Q.jsxs)(`b`,{children:[`≈`,e.shellC.toFixed(0),`°C`]})]},e.label))})]}),(0,Q.jsxs)(`section`,{className:`panel`,children:[(0,Q.jsx)(`h2`,{children:`观察方式`}),e===`cutaway`&&(0,Q.jsxs)(`label`,{className:`control`,children:[(0,Q.jsxs)(`span`,{children:[(0,Q.jsx)(`b`,{children:`统一纵剖位置`}),(0,Q.jsx)(`output`,{children:c===0?`正中半剖`:`${Math.round(c/180*100)}%`})]}),(0,Q.jsx)(`input`,{type:`range`,min:-180,max:180,step:5,value:c,onChange:e=>l(Number(e.target.value))}),(0,Q.jsxs)(`small`,{children:[(0,Q.jsx)(`i`,{children:`背侧`}),(0,Q.jsx)(`i`,{children:`正中`}),(0,Q.jsx)(`i`,{children:`前侧`})]})]}),e===`exploded`&&(0,Q.jsxs)(`label`,{className:`control`,children:[(0,Q.jsxs)(`span`,{children:[(0,Q.jsx)(`b`,{children:`轴向分离程度`}),(0,Q.jsxs)(`output`,{children:[Math.round(u*100),`%`]})]}),(0,Q.jsx)(`input`,{type:`range`,min:.15,max:1,step:.05,value:u,onChange:e=>d(Number(e.target.value))}),(0,Q.jsx)(`p`,{children:`各部件沿共同轴线依次排列，气流自动隐藏。`})]}),e===`complete`&&(0,Q.jsx)(`p`,{className:`panel-copy`,children:`观察直筒式前机匣、无外壳的后段推进流、环道与尾部。`})]}),(0,Q.jsxs)(`section`,{className:`panel`,children:[(0,Q.jsx)(`h2`,{children:`气流显示`}),(0,Q.jsx)(`div`,{className:`flow-grid`,role:`group`,"aria-label":`气流类型`,children:yd.map(e=>(0,Q.jsxs)(`button`,{className:`${n===e.id?`active`:``} ${e.id===`off`?`wide`:``}`,onClick:()=>r(e.id),children:[(0,Q.jsx)(`span`,{style:{background:e.color}}),e.label]},e.id))}),(0,Q.jsxs)(`label`,{className:`control compact`,children:[(0,Q.jsxs)(`span`,{children:[(0,Q.jsx)(`b`,{children:`流动速度`}),(0,Q.jsxs)(`output`,{children:[i.toFixed(2),`×`]})]}),(0,Q.jsx)(`input`,{type:`range`,min:.25,max:2,step:.05,value:i,onChange:e=>a(Number(e.target.value))})]}),(0,Q.jsxs)(`div`,{className:`switch-row`,children:[(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`b`,{children:`风扇旋转`}),(0,Q.jsx)(`small`,{children:`主风扇、环道外缘转子与两级区间增压风扇`})]}),(0,Q.jsx)(`button`,{className:`switch ${o?`on`:``}`,onClick:()=>s(e=>!e),"aria-pressed":o,children:(0,Q.jsx)(`i`,{})})]})]})]})]})]})}(0,N.createRoot)(document.getElementById(`root`)).render((0,Q.jsx)(D.StrictMode,{children:(0,Q.jsx)(bd,{})}));